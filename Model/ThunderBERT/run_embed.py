    ...
    with tf.Session() as sess:
        ...
        while True:
            try:
                ...
                address_id_v, sequence_output_v  = sess.run([features["address"], sequence_output])
        ...
        embed_output_file = "./data/thunderbert_embedding_" + model_index + "_" + FLAGS.bizdate + ".npy"
        print(embed_output_file)
        np.save(embed_output_file, sequence_output_vector_list)
        address_output_file = "./data/address_for_embed_" + model_index + "_" + FLAGS.bizdate + ".npy"
